...
const SITE_CONFIG = {
  ...
  agency: {
    ...
    specialties: ["문수로 비스타 더파크 전문상담", "문수비스타동원 전문상담", "울산 상가/건물 전문", "아파트/오피스텔 매매·임대", "수익형 부동산 자산분석"],
  ...
  complex: {
    ...
    modelHouseLocation: "울산광역시 남구 번영로 120 (달동 인근 9월 18일 오픈)",
    scale: "총 700세대 청정 대단지",
    types: "선호도 높은 68㎡ · 84㎡",
    openDate: "2026년 9월 18일 오픈",
